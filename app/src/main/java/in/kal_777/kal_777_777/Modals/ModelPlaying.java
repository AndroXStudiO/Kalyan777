...
public class ModelPlaying {
    ...
    public ModelPlaying(String game_id, String game_type, String session, String bid_points, String open_digit, String close_digit, String open_panna, String close_panna) {
